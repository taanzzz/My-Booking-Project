                  ...
                  {rooms.map((room) => (
                    ...
                    >
                      ...
                      <div className="p-5 flex flex-col flex-grow">
                        <h2 className="text-2xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
                          {room.name}
                        </h2>

                        <div className="flex flex-wrap gap-2 mb-4">
                          <span
                            className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full font-semibold text-xs ${badgeColors.location}`}
                          >
                            <MdLocationOn /> {room.location}
                          </span>
                          <span
                            className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full font-semibold text-xs ${badgeColors.guests}`}
                          >
                            <BsPeopleFill /> {room.maxGuests} Guests
                          </span>
                        </div>
                        <p className="text-gray-600 dark:text-gray-400 mb-5 flex-grow text-sm leading-relaxed">
                  ...
                  <table className="w-full text-left text-sm">
                    <thead className="bg-gray-100 dark:bg-gray-700/50 text-xs text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                      <tr>
                        ...
                        <th
                          scope="col"
                          className="px-6 py-4 text-center hidden sm:table-cell"
                        >
                          Max Guests
                        </th>
                        <th
                              scope="col"
                          className="px-6 py-4 pl-1 text-right sm:pr-5 pr-3"
                           >
                          Price/Night
                               </th>
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {rooms.map((room) => (
                        ...
                        >
                          <td className="px-6 py-4 font-medium text-gray-900 dark:text-white">
                            <div className="flex items-center gap-4">
                              <img
                                ...
                                alt={room.name}
                                loading="lazy"
                                className="w-20 h-14 object-cover rounded-md block"
                              />
                          ...
                          <td className="px-6 py-4 text-center font-semibold pr-3 sm:pl-0 pl-1 text-emerald-600 dark:text-emerald-400">
                            ${room.price}
                          </td>
        ...
        {!loading && rooms.length === 0 && (
          <div className="text-center py-24">
            ...
            <p className="mt-3 text-gray-500 dark:text-gray-400">
              Try adjusting your price filters or check back later.
            </p>
          </div>
        )}
      </div>
